(self["webpackChunkvlinde_laravel_bugster"] = self["webpackChunkvlinde_laravel_bugster"] || []).push([["node_modules_vue3-apexcharts_dist_apexcharts_ssr_esm-fe46cd2d_js"],{
...
class B {
   ...
   */
  static getApex() {
    return typeof window < "u" && window.Apex ? window.Apex : typeof __webpack_require__.g < "u" && __webpack_require__.g.Apex ? __webpack_require__.g.Apex : {};
  }
}
class Lt {
...
class st {
  ...
  clippedImgArea(t) {
    ...
    c.appendChild(h);
    const d = B.isBrowser() ? window.SVG : __webpack_require__.g.SVG;
...
class Je {
  ...
  setupElements() {
    ...
    const o = B.isBrowser() ? window.SVG : __webpack_require__.g.SVG;
...
B.isBrowser() ? (typeof window.SVG > "u" && (window.SVG = Tt), typeof window.Apex > "u" && (window.Apex = {})) : typeof __webpack_require__.g < "u" && (typeof __webpack_require__.g.Apex > "u" && (__webpack_require__.g.Apex = {}), typeof __webpack_require__.g.SVG > "u" && (__webpack_require__.g.SVG = Tt));
const we = class zt {
  /**
  ...
  createLegendMarker({ i: t, fillcolor: e }) {
    ...
    if (h.height = (r + c) * 2 + "px", h.width = (r + c) * 2 + "px", h.left = n + "px", h.top = l + "px", s.config.legend.markers.customHTML)
      ...
      const p = new xt(this.ctx.w, this.ctx).getMarkerConfig({
        ...
        strokeWidth: c,
        size: r
      }), f = (B.isBrowser() ? window.SVG : __webpack_require__.g.SVG)().addTo(i).size("100%", "100%"), x = new P(this.w).drawMarker(0, 0, O(I({}, p), {
